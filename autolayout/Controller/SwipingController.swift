...
class SwipingController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    let pages = [
        ...
        Page(imageName: "heart_second", headerText: "2019 translation by H. Rackham", bodyText: "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti.")
    ]
